...
get_link_git() {
  ...
  print_banner
  printf "${WHITE} 💻 Insira o link do GITHUB do ClickrChat que deseja instalar:${GRAY_LIGHT}"
  printf "\n\n"
  read -p "> " link_git
}
...
inquiry_options() {
  ...
  print_banner
  printf "${WHITE} 💻 Bem vindo(a) ao Gerenciador ClickrChat, Selecione abaixo a proxima ação!${GRAY_LIGHT}"
  printf "\n\n"
  printf "   [0] Instalar ClickrChat\n"
  printf "   [1] Atualizar ClickrChat\n"
  printf "   [2] Deletar ClickrChat\n"
  printf "   [3] Bloquear ClickrChat\n"
  printf "   [4] Desbloquear ClickrChat\n"
  printf "   [5] Alter. dominio ClickrChat\n"
  printf "\n"
  read -p "> " option
